                ...
                <div class="card">
                    <div class="table-header">
                        <div class="filter_section d-flex align-items-center me-2">
                            <form action="{{ route('admin.campaigns.index') }}" method="get" class="mb-0">
...
@push('js')
    <script>
        ...
        $(document).on('click', '.export_btn', function (e) {
            ...
            let url = `/admin/campaigns/export?status=${selectedStatus}&sort_filter=${sort_filter}&status_filter=${status_filter}`;
        ...
        function renderGridView() {
            ...
            currentItems.forEach(function(campaign) {
                ...
                // const userImageUrl = "{{ url('') }}/" + campaign.user.img ?? "{{ url('') }}/backend/img/user.svg";
                const userImageUrl = "{{ url('') }}/backend/img/user.svg";

                const card = `
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <a href="{{ url('admin/campaigns/${campaign.id}') }}">
