   ...
   <div class="container-xxl flex-grow-1 container-p-y">
       ...
       <a href="{{ route('admin.campaigns-pricing.index') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.campaigns-pricing.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="price" id="price" placeholder="{{__('trans.pricing.price_text')}}" required>
                            </div>
                        </div>
                    </div>
